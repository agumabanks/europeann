<div role="main" class="main">
				<div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center show-dots-hover show-dots-xs show-dots-sm show-dots-md dots-light custom-nav-arrows-1 nav-dark nav-md nav-font-size-md show-nav-hover mb-0" data-plugin-options="{'autoplayTimeout': 9000}" style="height: 100vh;">
					<div class="owl-stage-outer">
						<div class="owl-stage">
							...
							<!-- Carousel Slide 1 -->
							<div class="owl-item position-relative pt-5" style="background-image: url(img/slides/slide-44.png); background-size: cover; background-position: center;">
							...
							<!-- Carousel Slide 3 -->
							<div class="owl-item position-relative pt-5" style="background-image: url(img/slides/s2.png); background-size: cover; background-position: center;">
								<div class="container position-relative z-index-3 pb-5 h-100">
									<div class="row align-items-center pb-5 h-100">
										<div class="col">
											<h1 class="custom-secondary-font text-color-light font-weight-extra-bold text-8 line-height-1 line-height-sm-3 mb-5 appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="500" data-plugin-options="{'minWindowWidth': 0}">Get your<br><span class="custom-secondary-font text-4-5">Free Consultation</span></h1>
							...
							<!-- Carousel Slide 2 -->
							<div class="owl-item position-relative pt-5" style="background-image: url(img/slides/slide-2.png); background-size: cover; background-position: center;">
								<div class="container position-relative z-index-3 pb-5 h-100">
									<div class="row align-items-center pb-5 h-100">
										<div class="col">
							...
							<div class="col-md-3 d-flex justify-content-md-end mb-4 mb-md-0">
								<a class="text-decoration-none" href="tel:+00112304567" target="_blank" title="Call Us Now">
									<span class="custom-call-to-action">
										...
										<span class="action-info text-color-light">+256 39 4819346</span>
									</span>
								</a>
							</div>
							<div class="col-md-3 col-lg-2">
								<a class="text-decoration-none" href="mail:mail@example.com" target="_blank" title="Email Us Now">
									<span class="custom-call-to-action">
										...
										<span class="action-info text-color-light">info@europeannimpact.com</span>
									</span>
								</a>
							</div>
						</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-6 col-lg-6">
								...
								<p class="ps-4">We are private MIS, M&E  infrastructure majoring in capacity building, effectiveness, efficiency, results based frameworks, public health, diagnostics and green agriculture broadly  donor funded projects.</p>
								<div class="ps-4">
									<div class="row">
										<div class="col-lg-6">
								...
								<a href="demo-business-consulting-expertise-detail.html" class="text-decoration-none appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="0">
									<div class="feature-box custom-feature-box feature-box-style-2">
										<div class="feature-box-icon">
											<img src="img/team/expertise.png" alt="">
										</div>
						...
						<div class="row">
							<div class="col-lg-4">
								<a href="demo-business-consulting-expertise-detail.html" class="text-decoration-none appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
									<div class="feature-box custom-feature-box feature-box-style-2">
										<div class="feature-box-icon">
											<img src="img/team/e4.png" alt="">
										</div>
										<div class="feature-box-info ms-3">
											<h4 class="font-weight-normal text-5">Environmental Impact Assessment</h4>
											<p class="text-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla volutpat ex finibus urna.</p>
										</div>
									</div>
								</a>
				...
				<section class="custom-section-padding">
					<div class="container">
						<div class="row mb-3">
							<div class="col-lg-6">
								<h2 class="font-weight-bold text-color-dark">- Our Events</h2>
									...
									<div>
										<div class="custom-step-item">
											...
											<div class="step-content">
												<h4 class="mb-3">ORGANIC FARMING FOR EXPORTS<br> <strong> TRAINING OPPORTUNITIES</strong></h4>
												<p>On-going for only organic farmers / investors in milk, coffee, tea, wine, fruits, Honey, cereals, rice and wheat industry. MUST be registered company/individuals.</p>
											</div>
										</div>
									</div>
									<div>
										<div class="custom-step-item">
											...
											<div class="step-content">
												<h4 class="mb-3">MONITORING AND EVALUATION<br> <strong> TRAINING OPPORTUNITIES</strong></h4>
												<p>Assessment of performance of M&E Systems on donor funded projects. in Uganda, Ethiopia, Rwanda, Kenya, Egypt, Tanzania, Ghana, South Sudan and DRC.</p>
											</div>
										</div>
									</div>
									<div>
								...
								<div class="accordion without-bg custom-accordion-style-1" id="accordion7">
									...
									<div class="card card-default">
										...
										<div id="collapse7Three" class="collapse" aria-expanded="false" style="height: 0px;">
											<div class="card-body">
												<p>Please provide some more info Degree or Diploma in economics, finance, resource mobilization, HR, social </p>
											</div>
										</div>
									</div>
									<div class="card card-default">
					...
					<div class="owl-carousel show-nav-title custom-both-sides-shadow custom-dots-position-2 custom-dots-style-1 custom-xs-arrows-style-2 mb-0" data-plugin-options="{'items': 6, 'loop': false, 'dots': true, 'nav': false}">
							...
							<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/team/cee.png" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-secondary p-4 pt-5 pb-5">
										<span class="custom-thumb-info-title">
											<span class="custom-thumb-info-name font-weight-semibold text-color-dark text-4">Monitoring and evaluation</span>
						...
						<div>
							<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/team/c33.png" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-secondary p-4 pt-5 pb-5">
										<span class="custom-thumb-info-title">
											<span class="custom-thumb-info-name font-weight-semibold text-color-dark text-4">Environmental Impact Assessment</span>
											<span class="custom-thumb-info-desc font-weight-light">Sanaa</span>
										</span>
										<span class="custom-arrow"></span>
									</span>
								</span>
						...
						<div>
							<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/team/c41.png" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-secondary p-4 pt-5 pb-5">
										<span class="custom-thumb-info-title">
						...
						<div>
							<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/team/c44.png" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-secondary p-4 pt-5 pb-5">
										<span class="custom-thumb-info-title">
						...
						<div>
							<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/team/crr.png" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-secondary p-4 pt-5 pb-5">
										<span class="custom-thumb-info-title">
						...
						<div>
							<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/team/cpp.png" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-secondary p-4 pt-5 pb-5">
										<span class="custom-thumb-info-title">
						...
						<div>
							<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/team/crg.png" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-secondary p-4 pt-5 pb-5">
										<span class="custom-thumb-info-title">
						...
						<div>
							<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/team/cc1.png" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-secondary p-4 pt-5 pb-5">
										<span class="custom-thumb-info-title">
											<span class="custom-thumb-info-name font-weight-semibold text-color-dark text-4">Brand Consulting</span>
											<span class="custom-thumb-info-desc font-weight-light">Sanaa Finance</span>
										</span>
										<span class="custom-arrow"></span>
									</span>
								</span>
						...
						<div>
							<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
								<span class="thumb-info custom-thumb-info-style-1 thumb-info-hide-wrapper-bg">
									<span class="thumb-info-wrapper m-0">
										<img src="img/team/cc3.png" class="img-fluid" alt="">
									</span>
									<span class="thumb-info-caption bg-color-secondary p-4 pt-5 pb-5">
										<span class="custom-thumb-info-title">
								...
								<div class="owl-carousel show-nav-title custom-dots-style-1 custom-dots-position custom-xs-arrows-style-2 mb-0" data-plugin-options="{'items': 1, 'autoHeight': true, 'loop': false, 'nav': false, 'dots': true}">
									<div class="row">
										<div class="col-8 col-sm-4 col-lg-2 text-center pt-5">
											<img src="img/team/testy.png" alt class="img-fluid custom-rounded-image" />
										</div>
										<div class="col-12 col-sm-12 col-lg-10">
											<div class="testimonial custom-testimonial-style-1 testimonial-with-quotes mb-0">
												<blockquote class="pb-2">
													<p>Please provice some more info Degree or Diploma in economics, finance, resource mobilization, HR, social sciences, development studies, natural sciences, research, public health, project management, agriculture and related fields.
Data collection, MIS, database, Research and M&E are of the added advantage.</p>
												</blockquote>
								...
								<div class="owl-carousel show-nav-title custom-dots-style-1 custom-dots-position custom-xs-arrows-style-2 mb-0" data-plugin-options="{'items': 4, 'margin': 20, 'autoHeight': true, 'loop': false, 'nav': false, 'dots': true}">
									...
									<div>
										<div class="team-item p-0">
											<a href="demo-business-consulting-team-detail.html" class="text-decoration-none">
												<span class="image-wrapper">
													<img src="img/team/22.png" alt="" class="img-fluid" />
												</span>
											</a>
											<div class="team-infos">
												<div class="share">
									...
									<div>
										<div class="team-item p-0">
											<a href="" class="text-decoration-none">
												<span class="image-wrapper">
													<img src="img/team/33.png" alt="" class="img-fluid" />
												</span>
											</a>
											<div class="team-infos">
												<div class="share">
									...
									<div>
										<div class="team-item p-0">
											<a href="demo-business-consulting-team-detail.html" class="text-decoration-none">
												<span class="image-wrapper">
													<img src="img/team/66.png" alt="" class="img-fluid" />
												</span>
											</a>
											<div class="team-infos">
												<div class="share">
									...
									<div>
										<div class="team-item p-0">
											<a href="demo-business-consulting-team-detail.html" class="text-decoration-none">
												<span class="image-wrapper">
													<img src="img/team/55.png" alt="" class="img-fluid" />
												</span>
											</a>
											<div class="team-infos">
												<div class="share">
							...
							<div class="col-md-3 d-flex justify-content-md-end mb-4 mb-md-0">
								<a class="text-decoration-none" href="tel:+00112304567" target="_blank" title="Call Us Now">
									<span class="custom-call-to-action white-border text-color-light">
										...
										<span class="action-info">+256 39 4819346</span>
									</span>
								</a>
							</div>
							<div class="col-md-3 col-lg-2">
								<a class="text-decoration-none" href="mail:mail@example.com" target="_blank" title="Email Us Now">
									<span class="custom-call-to-action white-border text-color-light">
										...
										<span class="action-info">info@europeannimpact.com</span>
									</span>
								</a>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-sm-8 col-lg-5">
										<div class="blog-post-image-wrapper">
											<img src="img/team/blog.png" alt class="img-fluid mb-4" />
									...
									<div class="col-sm-12 col-lg-7">
										<h2> EVALUATION TRAINING OPPORTUNITIES</h2>
										<p>Assessment of performance of M&E Systems on donor funded projects. Case study in Uganda, Ethiopia, Rwanda, Kenya, Egypt, Tanzania, Ghana, South Sudan and DRC.</p>
										<hr class="solid">
				...
				<section class="section section-text-light section-background m-0" style="background: url('img/team/bg2.png'); background-size: cover;">
					<div class="container">
						<div class="row justify-content-md-center">
							<div class="col-lg-6 mb-5 mb-lg-0">
								<h2 class="font-weight-bold">- Contact Us</h2>
								<p class="custom-opacity-font">We are available 7 days of the week, we provide service in the east and central African area</p>
								<div class="row">
									...
									<div class="col-md-6 custom-sm-margin-top">
										...
										<p class="custom-opacity-font">EUROPEANN IMPACT CONSULT  P.O Box 26700, Kampala. Uganda</p>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6 custom-sm-margin-top">
										<h4 class="mb-1">Mail Us</h4>
										<a href="mail:europeannconsult.ug@gmail.com" class="text-decoration-none" target="_blank" title="Mail Us">
											<span class="custom-call-to-action-2 text-color-light text-2 custom-opacity-font">
												Email
												<span class="info text-5">
												info@europeannimpact.com
												</span>
											</span>
										</a>
									</div>
