										...
										<div class="header-nav-main header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													...
													<li>
														<a class="nav-link active" href="demo-business-consulting-cases.html">
															Cases
														</a>
													</li>
													<li>
					...
					<div class="container">
						<div class="row mt-3">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								...
								<span class="d-block text-4">Okler Themes</span>
							</div>
							<div class="col-md-4 order-1 order-md-2 align-self-center">
								<ul class="breadcrumb d-block text-md-end breadcrumb-light">
									<li><a href="demo-business-consulting.html">Home</a></li>
									<li><a href="demo-business-consulting-cases.html">Cases</a></li>
				...
				<div class="container">
					<div class="row pt-1 pb-5 mb-3">
						...
						<div class="col">
							...
							<div class="portfolio-info">
								<div class="row">
									<div class="col">
										<ul>
											<li>
												<i class="fas fa-calendar-alt"></i> 01 January 2022
											</li>
											<li>
							...
							<img src="img/demos/business-consulting/cases/case-4.jpg" style="max-width: 260px;" class="img-fluid float-end ms-5 mb-4" alt="">
							...
							<div class="col-lg-6 mb-5 mb-lg-0">
								...
								<div class="row">
									...
									<div class="col-md-6 custom-sm-margin-top">
										...
										<p class="custom-opacity-font">EUROPEANN IMPACT CONSULT  123 Porto Blvd, Suite 100 New York, NY</p>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6 custom-sm-margin-top">
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 text-center pb-4">
							<p>2022 © Porto <span class="text-color-light">Business Consulting</span> - Copyright All Rights Reserved</p>
						</div>
					</div>
				</div>
			</footer>
